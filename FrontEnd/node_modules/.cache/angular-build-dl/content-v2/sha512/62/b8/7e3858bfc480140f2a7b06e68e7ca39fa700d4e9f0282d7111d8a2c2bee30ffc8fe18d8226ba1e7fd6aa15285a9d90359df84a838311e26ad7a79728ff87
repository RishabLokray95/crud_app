...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppCreateEmployeeCreateEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    CreateEmployeeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 5,
      consts: [[2, "width", "400px", 3, "hidden"], [3, "ngSubmit"], [1, "form-group"], ["for", "name"], ["type", "text", "id", "name", "required", "", "name", "firstName", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "email", "required", "", "name", "email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "phone", "required", "", "name", "phone", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-success"], [3, "hidden"]],
  ...
  function srcAppEmployeeListEmployeeListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EmployeeListComponent_tr_19_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function EmployeeListComponent_tr_19_Template_button_click_10_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function EmployeeListComponent_tr_19_Template_button_click_12_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function EmployeeListComponent_tr_19_Template_button_click_14_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3);
          ...
          return ctx_r5.updateEmployee(employee_r1.id);
        });
    ...
    var EmployeeListComponent = /*#__PURE__*/function () {
      ...
      _createClass(EmployeeListComponent, [{
        ...
        key: "celeryTask",
        value: function celeryTask() {
          console.log("herer");
          this.employeeService.postCeleryData(this.dumm).subscribe(function (data) {
            return console.log(data);
          }, function (error) {
            return console.log(error);
          });
    ...
    EmployeeListComponent.ɵfac = function EmployeeListComponent_Factory(t) {
      return new (t || EmployeeListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_employee_service__WEBPACK_IMPORTED_MODULE_2__["EmployeeService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };
    ...
    EmployeeListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 3,
      consts: [[1, "panel", "panel-primary"], [1, "panel-heading"], [1, "btn", "btn-danger", 3, "click"], [1, "panel-body"], [1, "table", "table-striped"], [4, "ngFor", "ngForOf"], [1, "btn", "btn-info", 2, "margin-left", "10px", 3, "click"], [1, "btn", "btn-info", 2, "margin-left", "20px", 3, "click"]],
      template: function EmployeeListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function EmployeeListComponent_Template_button_click_4_listener() {
            return ctx.celeryTask();
          });
    ...
    var EmployeeService = /*#__PURE__*/function () {
      ...
      _createClass(EmployeeService, [{
        ...
        value: function getEmployee(id) {
          return this.http.get("api/posts/".concat(id));
        }
      }, {
        key: "createEmployee",
        ...
        value: function updateEmployee(id, value) {
          return this.http.patch("api/posts/".concat(id), value);
        }
      }, {
        key: "deleteEmployee",
        value: function deleteEmployee(id) {
        ...
        key: "postCeleryData",
        value: function postCeleryData(employee) {
  ...
  function srcAppUpdateEmployeeUpdateEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UpdateEmployeeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 18,
      vars: 3,
      consts: [["hidden", "submitted", 2, "width", "400px"], [3, "ngSubmit"], [1, "form-group"], ["for", "name"], ["type", "text", "id", "name", "required", "", "name", "name", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "email", "required", "", "name", "email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "id", "phone", "required", "", "name", "phone", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-success"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/rishab/Desktop/crud_app/FrontEnd/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
